...
class SRUserProfile(models.Model):
    ...
    avator = models.ImageField(default='',upload_to=UPLOAD_TO,storage=ImageStorage, blank=True, null=True,verbose_name='头像')
    ...
    partner = models.ForeignKey("SRPartner", verbose_name=_("伴侣"), on_delete=models.CASCADE,default=None,blank=True, null=True)
...
class SRUserSportRecord(models.Model):
    ...
    remark = models.CharField(_("备注"), max_length=50, blank=True, null=True)
    # db_comment='采取的安全措施，1-无保护措施,2-安全套，3-吃药'
    measure = models.SmallIntegerField(_("安全措施"), default=0,help_text='采取的安全措施，1-无保护措施,2-安全套，3-吃药')
    ...
    shootPlace = models.ForeignKey("SRShootPlace", verbose_name=_("射精位置"), on_delete=models.SET_NULL, blank=True, null=True, default=None)
...
class SRPartner(models.Model):
    ...
    avator = models.ImageField(_("头像"), upload_to=UPLOAD_TO, height_field=None, width_field=None, max_length=None,default=None)
...
class SRScore(models.Model):
    ...
    icon = models.ImageField(_("分数图标"), upload_to=UPLOAD_TO, height_field=None, width_field=None, max_length=None, default=None,blank=True, null=True)
    class Meta:
        db_table = 'srscore'
        managed = True
        verbose_name = '分数'
...
class SRMood(models.Model):
    ...
    icon = models.ImageField(_("心情图标"), upload_to=UPLOAD_TO, height_field=None, width_field=None, max_length=None, default=None,blank=True, null=True)
    class Meta:
        db_table = 'srmood'
        managed = True
        verbose_name = '心情'
...
class SRShootPlace(models.Model):
    placeName = models.CharField(_("射精位置"), max_length=50)
    def __str__(self):
